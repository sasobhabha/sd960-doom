...
return {
  ...
  MIN_AV=28,         -- 27 is not always min AV.
  USER_AV=29,         -- 30 matches PROPCASE_AV, but doesn't set M/Av mode value
  ...
  DRIVE_MODE=108,        -- 0 = single, 1 = cont, 2 = cont AF, 3 = "Auto Drive"
  ...
  ASPECT_RATIO=307,        -- 0 = 4:3, 1 = 16:9, 2 = 3:2, 3 = 1:1, 4 = 4:5
