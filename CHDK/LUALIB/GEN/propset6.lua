...
return {
  ...
  REAL_FOCUS_MODE=6,          -- 0 = AF, 1 = Macro, 3 = INF, 4
  ...
  VIDEO_RESOLUTION=170,        -- 4=1280x720, 2=640x480 (elph130) 5=1920x1080 (elph340)
  ...
  EV_CORRECTION_2=210,
  IS_FLASH_READY=211,
  IMAGE_FORMAT=213,        -- 0 = RAW, 1 = JPEG, 2 = RAW+JPEG (G16)
  ...
  REVIEW_TIME=363,        -- Review time 0 = off, -1 = hold, 100 = quick, otherwise milliseconds
