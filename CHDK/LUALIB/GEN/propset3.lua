...
return {
  ...
  WB_ADJ=271,
  ASPECT_RATIO=298,     -- unverified, propset2 +4 based offset of nearby propcases
  TIMER_MODE=225,
  ...
  ND_FILTER_STATE=194,     -- 0 = out, 1 = in
  JPEG_WITH_RAW=284,     -- RAW+JPEG menu setting, 0 = Off, 1 = On
}
